<h1>Search by Flight Number</h1>
<form name="test" method="post">
<input type="text" name="sbm" value="" id="sbm" placeholder="Flight No "><p />
...
<?php
	...
	if ($conn->connect_error) 
		...
		if($conn->multi_query("Select * from flight where Flight_no='$username'"))
		{
	echo"<table border='1'>";
